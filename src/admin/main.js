...
var ExternalOrderShowComponent = /** @class */ (function () {
    ...
    ExternalOrderShowComponent.prototype.ngOnInit = function () {
        ...
        this.cancelForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormGroup"]({
            'reasonText': new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControl"](null),
            'reason': new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControl"](null)
        });
        this.loginDeapStream();
        this.fetchOrderReasons();
    };
    ...
    ExternalOrderShowComponent.prototype.changeStatus = function (id, status) {
        ...
        this.orderServices.updateExternalOrders(id, body)
            ...
            $('#myModal').modal('hide');
            if (res['status'] == 'REJECTED_BY_PROVIDER')
                _this.ngxSmartModalService.getModal('externalOrderReasonModal').open();
    ...
    ExternalOrderShowComponent.prototype.dsEventLisenning = function () {
        ...
        _da_service__WEBPACK_IMPORTED_MODULE_7__["default"].record.getRecord("dsOrder/" + this.orderId).subscribe(function (res) {
            // if (res.status == 'REJECTED_BY_PROVIDER') this.ngxSmartModalService.getModal('externalOrderReasonModal').open()
    ...
    ExternalOrderShowComponent.prototype.fetchOrderReasons = function () {
        var _this = this;
        this.loadingReason = true;
        this.cancelStatus = 'REJECTED_BY_PROVIDER_REASON';
        this.orderServices.getExternalOrderReasons(this.cancelStatus).subscribe(function (res) {
            _this.loadingReason = false;
            _this.reasons = res;
        });
    };
    ExternalOrderShowComponent.prototype.onCancelledOrder = function () {
        var _this = this;
        ...
        this.orderServices.addExternalReasons(this.orderId, reasonBody).subscribe(function (res) {
            _this.ngxSmartModalService.getModal('externalOrderReasonModal').close();
        }, function (err) {
...
var OrderDetailComponent = /** @class */ (function () {
    ...
    OrderDetailComponent.prototype.getProviderLocation = function () {
        var _this = this;
        this.orderServices.getProviderLocation(this.providerId)
            .subscribe(function (result) {
            _this.lng = result['currentLocation'][0],
    ...
    OrderDetailComponent.prototype.fetchOrder = function (orderId) {
        ...
        this.orderServices.getOrderById(this.providerId, orderId).subscribe(function (res) {
            ...
            _this.orderServices.getClientById(_this.order.client.id).subscribe(function (result) {
                ...
                _this.currentStatus = _this.order.status;
                if (_this.currentStatus == 'ENDED' && _this.order.isProviderWaitingForPayment == true) {
                    _this.closeNav();
                    _this.paymentMethod = true;
                }
...
var OrderServices = /** @class */ (function () {
    ...
    OrderServices.prototype.getExternalOrderReasons = function (type) {
        var url = this.basePath + 'external-reasons?type=' + type;
        return this.httpClient.get(url);
    };
    ...
    OrderServices.prototype.addExternalReasons = function (orderId, reasonBody) {
        var url = this.basePath + "external-orders/" + orderId + "/reason";
        return this.httpClient.patch(url, reasonBody);
    };
